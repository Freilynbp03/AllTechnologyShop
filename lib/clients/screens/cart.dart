...
import 'package:alltechnologyshop/clients/screens/product_details.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: CustomText(text: "Carrito de Compra"),
        leading: IconButton(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        GestureDetector(
                          onTap: () async{
                            print(userProvider.userModel.cart[index].productId);
                            print('Funciona');
                            await productProvider.ProductsCart(prodId: userProvider.userModel.cart[index].productId);
                            print(productProvider.ProductsCart(prodId: userProvider.userModel.cart[index].productId).toString());
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Total a Pagar \$${userProvider.userModel.totalCartPrice}',
                                        textAlign: TextAlign.center,
                                      ),
                                      SizedBox(
                                        width: 320.0,
