...
import 'package:alltechnologyshop/clients/screens/cart.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  void initState() {
    ...
    _condition = widget.product.condition[0];
  }
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: DropdownButton<String>(
                                ...
                                iconSize: 40,
                                style: TextStyle(color: white),
                                items: widget.product.condition
                                    .map<DropdownMenuItem<String>>(
                                        (value) => DropdownMenuItem(
                                            value: value,
                                            child: CustomText(
